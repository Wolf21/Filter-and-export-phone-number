...
<h3 style="color: blue">{{\Illuminate\Support\Facades\Session::get('file')}}</h3>
<br>
...
{{Form::close()}}
<br>
{{Form::open(['url'=>route('export-txt'), 'method' => 'POST'])}}
<input type="hidden" value="{{\Illuminate\Support\Facades\Session::get('fileName') ?? ''}}" name="old_file">
<button class="export-txt" name="export-txt" type="submit">Export TXT</button>
{{Form::close()}}
<br>
</body>
</html>
